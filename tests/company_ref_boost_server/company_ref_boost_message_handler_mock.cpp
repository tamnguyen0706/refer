/**
 ...
 @file company_ref_boost_message_handler_mock.cpp
...
CompanEdgeBoostMessageHandlerTest::CompanEdgeBoostMessageHandlerTest()
    : ctx_()
    , strand_(ctx_)
    , ws_(ctx_)
    , msgQueue_()
    , handler_(std::make_shared<CompanEdgeBoostWsMessageHandler>(ctx_, ws_, dmo_, 0))
    , boolId_("test.bool")
    , enumId_("test.enum")
    ...
    , nonExistId_("test.notfound")
{
    ...
    *intervalValue_.mutable_intervalvalue() = std::move(rangeValue);
    ...
    handler_->connectClientMessageListener(
            std::bind(&CompanEdgeBoostMessageHandlerTest::messageCompleted, this, std::placeholders::_1));
}
...
void CompanEdgeBoostMessageHandlerTest::messageCompleted(std::shared_ptr<CompanEdgeProtocol::ClientMessage> msgPtr)
{
    if (msgPtr) msgQueue_.push(*msgPtr);
}

void CompanEdgeBoostMessageHandlerTest::populateValueStore()
{
...
uint64_t CompanEdgeBoostMessageHandlerTest::getHashToken(std::string const& valueId)
{
...
CompanEdgeProtocol::ClientMessage CompanEdgeBoostMessageHandlerTest::queueGet()
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_ClientMessageHasNoVsResult(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_FALSE(rspMsg.has_vsresult());
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultSuccess(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_EQ(rspMsg.vsresult().values().size(), 0);
    EXPECT_EQ(rspMsg.vsresult().status(), CompanEdgeProtocol::VsResult_Status_success);
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultNotFound(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_EQ(rspMsg.vsresult().values().size(), 0);
    EXPECT_EQ(rspMsg.vsresult().status(), CompanEdgeProtocol::VsResult_Status_error_not_found);
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultWrongValueType(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsResultRangeError(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_EQ(rspMsg.vsresult().values().size(), 1);
    EXPECT_EQ(rspMsg.vsresult().status(), CompanEdgeProtocol::VsResult_Status_range_error);
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultEnumError(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_EQ(rspMsg.vsresult().values().size(), 1);
    EXPECT_EQ(rspMsg.vsresult().status(), CompanEdgeProtocol::VsResult_Status_enum_error);
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultAccessError(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
    EXPECT_EQ(rspMsg.vsresult().values().size(), 1);
    EXPECT_EQ(rspMsg.vsresult().status(), CompanEdgeProtocol::VsResult_Status_access_error);
}

void CompanEdgeBoostMessageHandlerTest::Validate_VsResultAll(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsResultSingle(
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsResultOffset(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_ValueChangedAll(CompanEdgeProtocol::ClientMessage const& rspMsg)
{
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueAddToContainer(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueRemoveFromContainer(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueChangedSingle(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId)
{
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueChangedOffset(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueTransientChangedOffset(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_ValueRemoved(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
...
bool CompanEdgeBoostMessageHandlerTest::Validate_ValueRemovedOffset(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsMultGetResultSuccess(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsMultGetResultNotFound(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        int const idx)
{
    ASSERT_TRUE(idx < rspMsg.vsmultigetresult().results().size());
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsMultSetResultSuccess(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsMultSetResultNotFound(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::Validate_VsMultSetResultFailure(
        CompanEdgeProtocol::ClientMessage const& rspMsg,
        std::string const& valueId,
        int const idx)
{
...
void CompanEdgeBoostMessageHandlerTest::run()
{
    ctx_.restart();
    ctx_.run();
}
