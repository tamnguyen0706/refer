/**
  ...
  @file test_company_ref_boost_message_handler_subscribe.cpp
...
TEST_F(CompanEdgeBoostMessageHandlerTest, VsSubscribe_Global)
{
...
TEST_F(CompanEdgeBoostMessageHandlerTest, VsSubscribe_Discrete)
{
...
TEST_F(CompanEdgeBoostMessageHandlerTest, VsSubscribe_DiscreteChildren)
{
    CompanEdgeProtocol::ClientMessage rspMsg;
    CompanEdgeProtocol::ServerMessage reqMsg;
