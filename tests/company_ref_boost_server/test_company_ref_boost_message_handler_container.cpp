/**
  ...
  @file test_company_ref_boost_message_handler_container.cpp
...
TEST_F(CompanEdgeBoostMessageHandlerTest, AddToContainer)
{
    ...
    *reqMsg.mutable_valuechanged()->add_value() = addToValue;
    ...
    EXPECT_EQ(
            coutWrapper_.pop(),
            "server.message.handler: Error: handleAddToContainer - Not a container: a.b.container1.2.container\n");

    EXPECT_EQ(addedValues, containerFail);
}

TEST_F(CompanEdgeBoostMessageHandlerTest, AddToSubscribedContainer)
{
    CompanEdgeProtocol::ClientMessage rspMsg;
    CompanEdgeProtocol::ServerMessage reqMsg;
...
TEST_F(CompanEdgeBoostMessageHandlerTest, RemoveFromContainer)
{
    CompanEdgeProtocol::ClientMessage rspMsg;
    CompanEdgeProtocol::ServerMessage reqMsg;
