/**
 ...
 @file company_ref_boost_message_handler_mock.h
 @brief Mock Message Handler
 */
#ifndef __company_ref_BOOST_MESSAGE_HANDLER_MOCK_H__
#define __company_ref_BOOST_MESSAGE_HANDLER_MOCK_H__

#include <gmock/gmock.h>

#include "Compan_logger_sink_buffered.h"

#include "company_ref_boost_server/company_ref_boost_ws_message_handler.h"
...
class CompanEdgeBoostMessageHandlerTest : public testing::Test {
public:
    typedef std::vector<std::pair<std::string, CompanEdgeProtocol::Value_Type>> IdValueTypeVector;

    CompanEdgeBoostMessageHandlerTest();

    virtual ~CompanEdgeBoostMessageHandlerTest();
    ...
    CompanEdgeBoostWsMessageHandler::Ptr handler_;
...
#endif // __company_ref_BOOST_MESSAGE_HANDLER_MOCK_H__
